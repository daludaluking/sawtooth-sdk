...
func init() {
	proto.RegisterFile("github.com/daludaluking/sawtooth_sdk/protobuf/client_list_control_pb2/client_list_control.proto", fileDescriptor_client_list_control_60bfc4d788568132)
}
